...
img = cv2.imread("fotos/todos.png")
...
for c in contours:
    ...
    if M['m00'] != 0:
        ...
        #mostramos la imagen
        cv2.putText(img, "GRIPPER", (cx-60,cy-20), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 2)
        MOVE_TO = "MOVE TO: "+ str(cx)+", "+str(cy)
        cv2.putText(img, MOVE_TO, (543,73), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,255,0), 2)
